...
const VALUES = [
  {
    ...
    description:
      "Protection absolue des transactions, des infrastructures et des données clients.",
  },
  {
    icon: Rocket,
    title: "Innovation & Audace",
    description:
      "Propulser les produits locaux sur des marchés compétitifs grâce à des stratégies modernes.",
  },
  {
    icon: Layers,
